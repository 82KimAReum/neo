...
--모든 오브젝트를 Group001 로 그룹화 하고, 이름에 Ground가 포함된 오브젝트를 선택, 그룹의 피봇을 Ground로 맞추고, 스케일 변경,마지막 다시 그룹화
--지형 오브젝트의 이름은 Ground 이어야함. 해당 스크립트에서 Group001는 예약어 입니다. 기존 모델어 Group001이 있다면 이름을 변경하기.
